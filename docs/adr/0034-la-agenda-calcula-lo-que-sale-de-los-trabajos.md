...
- Completa al [0010](0010-sincronizacion-replica-completa.md) (una tabla nueva en la réplica) y al
  ...
  diseño en dónde vive la agenda: ver Objeciones.
...
- **Dónde vive la agenda.** «Dónde vive la agenda» (`MAUN Agenda.dc.html`) pone Agenda en lugar de
  ...
  la agenda está en la barra lateral y en el riel; en el celular se llega por «Hoy en la agenda» de
  Inicio, «Anotar algo» es la primera acción del botón redondo y Avisos vive en Ajustes. En el celular
  la agenda queda a dos toques. Mudar Inicio queda para otro PR, con su diseño.
...
- **Dentro de la hoja del día, el deshacer es un aviso local.** La hoja es un `<dialog>` modal y deja
  inerte el aviso global, que no se podría tocar.
