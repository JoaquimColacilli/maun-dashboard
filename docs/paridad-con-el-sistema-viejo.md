...
Actualizado otra vez con el sueldo por mes (ADR 0072): como los fijos, el sueldo se topea por lo que le
falta al mes. El original lo topeaba por proyecto.
...
| `abrirMovForm('pago_diezmo')`              | Botón de la pestaña Diezmo | **Está.** «Registrar diezmo» abre el formulario con el tipo ya elegido, encima de Diezmo.                                                                                                                                             |
...
| **Finanzas** · tres barras                       | **Está**, en Inicio: sueldo del mes, meta de Cocos, diezmo pagado vs generado. **La del sueldo mide distinto, a propósito.** El original sumaba todo lo que entró al hogar, docencia incluida, contra un sueldo, y con dos cobros se llenaba. Hoy mide el sueldo que pagaron los cobros del mes contra **un** sueldo (ADR 0056), y desde el ADR 0072 los cobros tampoco pagan más que eso: el tope del sueldo es por mes. |
...
| Sueldo        | `min(cfg.sueldo, resto)`, **por proyecto**                                                           | tope **mensual**, como los fijos (ADR 0072); por proyecto solo el seed y lo ya congelado |
...
segundo cobro en el mes, se separan: el original vuelve a descontar el sueldo y los fijos enteros, y esta base solo lo que les
falta.
