...
Actualizado en el paso 11 (seguimiento). Con este paso está construido todo lo que el dueño pidió
en sus audios.
...
| Los insumos **no** salen de MAUN mientras está en `presupuestado`    | **No se replica, y queda para decidir.** La vista `libro_mayor` descuenta un gasto el día que se carga, en cualquier estado. Es decisión del ADR 0011: la base de un perdido es la seña menos esos gastos. Cambiarlo es una migración; está planteado en el ADR 0019. |
